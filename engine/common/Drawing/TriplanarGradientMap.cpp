...
void noob::triplanar_renderer::draw(const noob::drawable3d* drawable, const noob::mat4& model_mat, const noob::triplanar_renderer::uniform_info& info, uint8_t view_id) const
{
