...
namespace noob
{
	class prepared_shaders
	{
		public:
			...
			void draw(const noob::model* drawable, const prepared_shaders::info& uni, const noob::mat4& world_mat = noob::identity_mat4(), uint8_t view_id = 0) const
			{
				match(uni,
			...
			// TODO: Implement
			void draw_instanced(const noob::model* drawable, const prepared_shaders::info& uni, const std::vector<noob::mat4>& world_mats = { noob::identity_mat4() }, uint8_t view_id = 0) const
			{
