...
namespace noob
{
	class graphics
	{
		public:
			...
			static const noob::graphics::uniform invalid_uniform, colour_0, colour_1, colour_2, colour_3, blend_0, blend_1, tex_scales, normal_mat, normal_mat_modelspace, eye_pos, eye_pos_normalized, global_ambient, light_pos_radius, light_rgb_intensity, specular_shine, diffuse, ambient, emissive, fog, rough_albedo_fresnel;
