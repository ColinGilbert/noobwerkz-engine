...
void noob::basic_renderer::init()
{
	...
	else logger::log("[Basic Renderer] program valid? true");
...
void noob::basic_renderer::draw(const noob::model* model, const noob::mat4& world_mat, const noob::basic_renderer::uniform_info& info, uint8_t view_id) const
{
