...
void noob::basic_renderer::draw(const noob::drawable* model, const noob::mat4& world_mat, const noob::basic_renderer::uniform& uni, const std::array<noob::vec4, 2>& ambient_lights, uint8_t view_id) const
{
