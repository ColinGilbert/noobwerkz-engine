...
namespace noob
{
	...
	class stage
	{
		public:
			...
			noob::bodies::handle sphere_body(float mass, float r, noob::vec3& pos);
			noob::bodies::handle box_body(float mass, float x, float y, float z, noob::vec3& pos);
			noob::bodies::handle capsule_body(float mass, float r, float h, noob::vec3& pos);
			noob::bodies::handle cone_body(float mass, float r, float h, noob::vec3& pos);
			noob::bodies::handle cylinder_body(float mass, float r, float h, noob::vec3& pos);
			noob::bodies::handle static_mesh_body(const noob::meshes::handle h, const noob::vec3& pos);
