...
void noob::font::init(const std::string& font_path)
{
	...
	// font_manager = new FontManager(512);
	...
	// font_manager->preloadGlyph(ttf_fonthandle, L"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ. \n");
...
void noob::font::drawtext(const std::string& str, float x_pos, float y_pos)
{
