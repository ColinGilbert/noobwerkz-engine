...
{
	int r;
	r = script_engine->RegisterObjectType("scaled_model", sizeof(noob::scaled_model), asOBJ_VALUE | asOBJ_POD | asGetTypeTraits<noob::body_handle>() | asOBJ_APP_CLASS_ALLINTS); assert(r >= 0 );
