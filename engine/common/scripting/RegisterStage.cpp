...
void noob::register_stage(asIScriptEngine* script_engine)
{
	...
	r = script_engine->RegisterObjectMethod("stage", "body_handle add_body(body_type, const shape_handle, float, const vec3& in, const versor& in, bool)", asMETHOD(noob::stage, add_body), asCALL_THISCALL); assert( r >= 0 );	
	r = script_engine->RegisterObjectMethod("stage", "void actor(const body_handle, const animated_model_handle, const shader_handle)", asMETHODPR(noob::stage, actor, (const noob::body_handle, const noob::animated_model_handle, const noob::globals::shader_results), void), asCALL_THISCALL); assert( r >= 0 );
	r = script_engine->RegisterObjectMethod("stage", "void actor(const body_handle, const scaled_model, const shader_handle)", asMETHODPR(noob::stage, actor, (const noob::body_handle, const noob::scaled_model, const noob::globals::shader_results), void), asCALL_THISCALL); assert( r >= 0 );
	// r = script_engine->RegisterObjectMethod("stage", "void actor(const shape_handle, float, const vec3& in, const versor& in, const scaled_model, const shader_handle)", asMETHODPR(noob::stage, actor, (const noob::body_handle, float, const noob::vec3&, const noob::versor&, const noob::scaled_model, const noob::shader_handle), void), asCALL_THISCALL); assert( r >= 0 );
	// void actor(const noob::shape_handle, float mass, const noob::vec3& pos, const noob::versor& orient, const noob::shader_handle)
	r = script_engine->RegisterObjectMethod("stage", "void actor(const shape_handle, float, const vec3& in, const versor& in, const shader_handle, const reflectance_handle)", asMETHODPR(noob::stage, actor, (const noob::shape_handle, float mass, const noob::vec3&, const noob::versor&, const noob::globals::shader_results, const reflectance_handle), void), asCALL_THISCALL); assert( r >= 0 );
