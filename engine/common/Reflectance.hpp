...
namespace noob
{
	struct reflectance
	{
		reflectance() noexcept(true) : specular_shine(noob::vec4(1.0, 1.0, 1.0, 32.0)), diffuse_albedo(noob::vec4(0.7, 0.7, 0.7, 0.4)), emissive_fresnel(noob::vec4(0.0, 0.0, 0.0, 0.3)) {}
