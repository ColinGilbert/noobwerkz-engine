...
bool GLText::init(const std::string& font, int font_sz, float screen_w, float screen_h)
{
	filename = "fonts/" + font;
...
void GLText::resize_screen(float width, float height)
{
...
void GLText::draw_text(const std::string& text, float x, float y)
{
...
void GLText::set_font_color(float r, float g, float b, float a)
{
	/*
	   color.red = r;
	   color.blue = b;
...
bool GLText::pack_atlas(const std::string& letters)
{
