#include "VoxelWorldStable.hpp"

#include <PolyVox/CubicSurfaceExtractor.h>
#include <PolyVox/MarchingCubesSurfaceExtractor.h>
#include <PolyVox/Mesh.h>
/*
noob::voxel_world_stable::voxel_world_stable()
{
	world_width = 256;
	world_height = 256;
	world_depth = 256;
...
void noob::voxel_world_stable::init(size_t x, size_t y, size_t z)
{
	world_width = x;
	world_height = y;
	world_depth = z;
...
void noob::voxel_world_stable::set(size_t x, size_t y, size_t z, uint8_t value)
{
...
void noob::voxel_world_stable::apply_to_region(size_t lower_x, size_t lower_y, size_t lower_z, size_t upper_x, size_t upper_y, size_t upper_z, std::function<uint8_t(size_t, size_t, size_t)> functor)
{
...
void noob::voxel_world_stable::sphere(size_t radius, size_t origin_x, size_t origin_y, size_t origin_z, bool fill)
{
...
void noob::voxel_world_stable::box(size_t lower_x, size_t lower_y, size_t lower_z, size_t upper_x, size_t upper_y, size_t upper_z, bool fill)
{
...
uint8_t noob::voxel_world_stable::get(size_t x, size_t y, size_t z) const
{
	return world->getVoxel(x, y, z);
}


uint8_t noob::voxel_world_stable::safe_get(size_t x, size_t y, size_t z) const
{
...
noob::basic_mesh noob::voxel_world_stable::extract_smooth() const
{
	return extract_region_smooth(0, 0, 0, world_width, world_height, world_depth);
}


noob::basic_mesh noob::voxel_world_stable::extract_cubic() const
{
	return extract_region_cubic(0, 0, 0, world_width, world_height, world_depth);
}
		

noob::basic_mesh noob::voxel_world_stable::extract_cubic(uint8_t bitmask) const
{
	return extract_region_cubic(0, 0, 0, world_width, world_height, world_depth, bitmask);
}


noob::basic_mesh noob::voxel_world_stable::extract_region_smooth(size_t lower_x, size_t lower_y, size_t lower_z, size_t upper_x, size_t upper_y, size_t upper_z) const
{
...
noob::basic_mesh noob::voxel_world_stable::extract_region_cubic(size_t lower_x, size_t lower_y, size_t lower_z, size_t upper_x, size_t upper_y, size_t upper_z) const
{
...
noob::basic_mesh noob::voxel_world_stable::extract_region_cubic(size_t lower_x, size_t lower_y, size_t lower_z, size_t upper_x, size_t upper_y, size_t upper_z, uint8_t bitmask) const
{
