...
void noob::application::user_init()
{
	...
	auto shader_id = stage.add_shader(u, "moon");
	auto actor_id = stage.add_actor(stage.basic_models.get_handle("unit-sphere"), stage.skeletons.get_handle("null"), noob::vec3(0.0, 80.0, 0.0));
